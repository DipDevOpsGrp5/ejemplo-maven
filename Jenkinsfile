    ...
    stages {
        ...
        stage('Paso 5: Subir Nexus') {
            steps {
                ...
                nexusPublisher nexusInstanceId: 'nexus', nexusRepositoryId: 'devops-grupo5', packages: [[$class: 'MavenPackage', mavenAssetList: [[classifier: '', extension: '', filePath: '/var/jenkins_home/workspace/job-github-sonar-3/build/DevOpsUsach2020-0.0.1.jar']], mavenCoordinate: [artifactId: 'DevOpsUsach2020', groupId: 'com.devopsusach2020', packaging: 'jar', version: '1.0.0']]]
            }
        }
        stage('Paso 6: Bajar Nexus') {
            steps {
                echo 'Bajando nexus desde código'
                sh 'curl -X GET -u $NEXUS_USER_VAR:$NEXUS_USER_PASS_VAR "http://nexus:8081/repository/devops-grupo5/com/devopsusach2020/DevOpsUsach2020/1.0.0/DevOpsUsach2020-1.0.0.jar" -O'
            }
        }
